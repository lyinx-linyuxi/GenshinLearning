...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        scores = current_score - last_score
        if scores > running_high:
            print(current_score - last_score, "point(s)! The most yet for Player", who)
        else:
            scores = running_high
        return announce_highest(who, current_score, scores)
    return say
    # END PROBLEM 7
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(bacon_score, opponent_score):
        return 0
    return bacon_strategy(bacon_score, opponent_score, cutoff, num_rolls)
    # END PROBLEM 11
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score >= opponent_score:
        if score + free_bacon(opponent_score) >= 100:
            ...
            return extra_turn_strategy(score, opponent_score, min(10, 100 - score), 3)
    else:
        return extra_turn_strategy(score, opponent_score, min(opponent_score - score, 10), 10)
    # END PROBLEM 12
