...
bool need_valC =
	f_icode in { IIRMOVQ, IIADDQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL };
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IIADDQ, IMRMOVQ  } : D_rB;
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IIADDQ, IOPQ} : D_rB;
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IIADDQ, IRMMOVQ, IMRMOVQ } : E_valC;
...
word aluB = [
	E_icode in { IRMMOVQ, IIADDQ, IMRMOVQ, IOPQ, ICALL, 
